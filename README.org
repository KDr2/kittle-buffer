...
* How to use
  There are [[http://cxan.kdr2.com/kittle-buffer/][pre-built binaries hosted here]]:
  - [[http://cxan.kdr2.com/kittle-buffer/kittle-buffer-linux-v0.1.zip][Linux]]
  - [[http://cxan.kdr2.com/kittle-buffer/kittle-buffer-win64-v0.1.zip][Windows]]
  - [[http://cxan.kdr2.com/kittle-buffer/kittle-buffer-macos-v0.1.zip][macOS]]
